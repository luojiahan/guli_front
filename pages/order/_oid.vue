    ...
    <form id="flowForm" name="flowForm" method="post" action="">
      ...
      <div class="Finish">
        <div id="AgreeDiv" class="fr">
          <label for="Agree"><p class="on"><input
            type="checkbox"
            checked="checked">我已阅读并同意<a href="javascript:" target="_blank">《谷粒学院购买协议》</a></p></label>
        </div>
        <div class="clear"/>
        <div class="Main fl">
          <div class="fl">
          ...
          <div class="fr">
            <p>共 <strong class="red">1</strong> 件商品，合计<span
              class="red f20">￥<strong id="AllPrice">{{ order.totalFee }}</strong></span></p>
          </div>
        </div>
